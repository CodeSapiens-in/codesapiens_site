...
const StatsSection = () => {
    ...
    return (
        <section className="py-12 bg-gradient-to-br from-[#0A0A0F] via-[#0D0D2B] to-[#0A0A0F] text-white relative overflow-hidden">
            {/* Background Elements */}

            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="mb-8 text-center">
                    <span className="text-[#00C6F7] font-bold tracking-widest uppercase text-golden-1 mb-4 block">Impact</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start md:items-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-8">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-[#0D0D2B]/80 backdrop-blur-3xl p-4 md:p-6 rounded-2xl border border-[#00C6F7]/20 hover:border-[#00C6F7]/60 text-center shadow-[0_8px_32px_0_rgba(0,198,247,0.1)] hover:shadow-[0_8px_40px_0_rgba(0,198,247,0.25)] transition-all duration-500 relative overflow-hidden group"
                        >
                            {/* Specular Highlight */}
                            <div className="absolute inset-0 bg-gradient-to-br from-[#00C6F7]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>

                            <h3 className="text-golden-2 md:text-golden-3 font-black text-transparent bg-clip-text bg-gradient-to-r from-[#00C6F7] to-[#A855F7] mb-2 drop-shadow-lg">
                        ...
                        <motion.div
                            ...
                            className="bg-[#0D0D2B]/80 backdrop-blur-3xl p-4 md:p-6 rounded-2xl border border-[#A855F7]/20 hover:border-[#A855F7]/60 text-center shadow-[0_8px_32px_0_rgba(168,85,247,0.1)] hover:shadow-[0_8px_40px_0_rgba(168,85,247,0.25)] transition-all duration-500 relative overflow-hidden group"
                        >
                            {/* Specular Highlight */}
                            ...
                            <h3 className="text-golden-2 md:text-golden-3 font-black text-transparent bg-clip-text bg-gradient-to-r from-[#A855F7] to-[#00C6F7] mb-2 drop-shadow-lg">
                    ...
                    <div className="col-span-1 h-full w-full overflow-hidden">
                        <div className="bg-[#0D0D2B]/80 backdrop-blur-3xl p-6 rounded-2xl border border-[#00C6F7]/20 h-full flex flex-col relative overflow-hidden group shadow-[0_8px_32px_0_rgba(0,198,247,0.1)]">
                            {/* Specular Highlight */}
                                                ...
                                                .map((college, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="px-3 py-1 rounded-full bg-[#00C6F7]/10 text-[#00C6F7] text-xs font-bold">
                                                                {college.count}
                                                            </div>
                                                        </motion.div>
                                                    );
...
const SponsorSection = () => {
    ...
    return (
        <section className="py-12 bg-[#0F0F1A] relative overflow-hidden">
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-left mb-8">
                    <div className="flex items-center gap-2 mb-4">
                        <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-none">OUR</h2>
                        <h2 className="text-4xl md:text-6xl font-script text-[#00C6F7] font-bold italic leading-none pt-2">sponsors</h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full mx-auto">
                    {sponsors.map((sponsor, idx) => (
                        <a
                            ...
                            className="relative group bg-[#0D0D2B] border border-[#00C6F7]/20 hover:border-[#00C6F7]/60 rounded-3xl p-4 md:p-6 w-full aspect-square flex flex-col justify-between hover:shadow-[0_8px_40px_0_rgba(0,198,247,0.2)] transition-all duration-300 transform hover:-translate-y-1 block"
                        >
                            {/* Top Right Arrow */}
                            <div className="self-end p-2 bg-white/5 rounded-full text-gray-400 group-hover:bg-[#00C6F7] group-hover:text-black transition-colors">
                            ...
                            <div className="self-start px-3 py-1 bg-white/5 border border-white/10 rounded-lg">
                                <span className="font-bold text-gray-300 text-xs">{sponsor.name}</span>
                            </div>
                        </a>
                    ))}
                </div>
...
const CommunityPartners = () => {
    ...
    return (
        <section className="py-12 bg-[#0A0A0F] relative overflow-hidden border-t border-[#00C6F7]/10">
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-left mb-8">
                    <div className="flex items-center gap-2 mb-4">
                        <h2 className="text-3xl md:text-6xl font-black text-white tracking-tight leading-none">COMMUNITY</h2>
                        <h2 className="text-3xl md:text-6xl font-script text-[#A855F7] font-bold italic leading-none pt-2">partners</h2>
                        <div className="h-px bg-gray-200 flex-1 ml-4 self-center mt-2"></div>
                    </div>
                    <div className="flex items-center gap-2 mb-8">
                        <span className="w-3 h-3 rounded-full bg-green-400 animate-pulse"></span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 w-full mx-auto">
                    {partners.map((partner, idx) => (
                        <div
                            key={idx}
                            className="relative group bg-[#0D0D2B] border border-[#A855F7]/20 hover:border-[#A855F7]/60 rounded-3xl p-4 md:p-6 w-full aspect-square flex flex-col justify-center items-center hover:shadow-[0_8px_40px_0_rgba(168,85,247,0.2)] transition-all duration-300"
                        >
                            {/* Centered Image */}
...
const SocialMediaSection = () => {
    ...
    return (
        <section className="py-20 bg-[#0A0A0F] relative overflow-hidden text-left">
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-left mb-8">
                    <div className="flex items-center gap-2 mb-4">
                        <h2 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-none">SOCIAL</h2>
                        <h2 className="text-4xl md:text-6xl font-script text-[#00C6F7] font-bold italic leading-none pt-2">links</h2>
                        <div className="h-px bg-gray-200 flex-1 ml-4 self-center mt-2"></div>
                    </div>
                    <div className="flex items-center gap-2 mb-8">
...
const NoticeSection = () => {
    return (
        <section className="py-4 bg-[#0D0D2B] relative overflow-hidden text-left">
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-4 md:gap-8 items-center max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <h2 className="text-xl md:text-2xl font-black text-white tracking-tight leading-none">LATEST</h2>
                        <h2 className="text-xl md:text-2xl font-script text-[#00C6F7] font-bold italic leading-none pt-1">updates</h2>
...
const CodeSapiensHero = () => {
    ...
    return (
        <div className="bg-[#0A0A0F] text-white min-h-screen font-sans overflow-x-hidden selection:bg-[#00C6F7] selection:text-black">
            {/* Navigation - Dark Mode for Hero */}
            <nav className="fixed top-0 w-full z-50 bg-[#0A0A0F]/95 backdrop-blur-md text-white border-b border-[#00C6F7]/20">
                <div className="container mx-auto px-6 py-6 flex justify-between items-center">
                    ...
                    <div className="hidden md:flex items-center gap-8 font-medium text-golden-1">
                        <a href="#vision" className="hover:text-[#00C6F7] transition-colors">Vision</a>
                        <a href="/programs" className="hover:text-[#00C6F7] transition-colors">Programs</a>
                        <a href="/meetups" className="hover:text-[#00C6F7] transition-colors">Meetups</a>
                        <a href="#events" className="hover:text-[#00C6F7] transition-colors">Events</a>
                        <a href="#community" className="hover:text-[#00C6F7] transition-colors">Community</a>
                        <button onClick={() => navigate('/auth')} className="hover:text-[#00C6F7]">Log in</button>
                        <button onClick={() => navigate('/auth')} className="bg-gradient-to-r from-[#00C6F7] to-[#A855F7] text-black px-5 py-2.5 rounded-sm hover:opacity-90 transition-all font-bold">
                            Get Started
                        </button>
                    </div>
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="fixed inset-0 z-40 bg-[#0A0A0F] text-white pt-24 px-6 md:hidden">
                    <div className="flex flex-col gap-6 text-golden-2 font-bold">
                        ...
                        <button onClick={() => navigate('/auth')} className="text-left text-[#00C6F7]">Log in</button>
                    </div>
                </div>
            )}

            {/* Hero Section */}
            <section className="relative min-h-screen bg-[#0A0A0F] text-white flex items-center overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-96 h-96 bg-[#A855F7] rounded-full blur-[120px] opacity-10 pointer-events-none"></div>
                {/* Cyan glow bottom right */}
                <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#00C6F7] rounded-full blur-[120px] opacity-10 pointer-events-none"></div>
                <motion.div
                ...
                >
                    <svg viewBox="0 0 800 800" className="w-full h-full md:w-full md:h-full opacity-40 md:opacity-60">
                        <motion.path
                            ...
                            fill="none" stroke="#00C6F7" strokeWidth="1.5"
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1] tracking-tighter mb-8 font-archivo-black">
                                CodeSapiens<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00C6F7] to-[#A855F7]">.</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                <button onClick={() => navigate('/auth')} className="bg-gradient-to-r from-[#00C6F7] to-[#A855F7] text-black px-8 py-4 text-golden-1 font-bold rounded-sm hover:opacity-90 transition-all flex items-center justify-center gap-3 group shadow-[0_0_30px_rgba(0,198,247,0.3)]">
                        ...
                        >
                            <div className="relative rounded-xl overflow-hidden shadow-2xl border border-[#00C6F7]/20 group transition-transform duration-500">
                                <div className="absolute inset-0 bg-gradient-to-tr from-[#00C6F7]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 pointer-events-none"></div>
                                <img
                            ...
                            {/* Decorative Elements */}
                            <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-[#00C6F7] rounded-full blur-[80px] opacity-30"></div>
                            <div className="absolute -top-10 -left-10 w-40 h-40 bg-[#A855F7] rounded-full blur-[80px] opacity-30"></div>
            ...
            {/* Vision Section */}
            <section id="vision" className="bg-[#0F0F1A] text-white py-12 md:py-16 relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 h-32 w-px bg-gradient-to-b from-[#00C6F7] to-[#A855F7]"></div>
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-16 items-start">
                        <div className="relative md:sticky md:top-32">
                            <span className="text-[#00C6F7] font-bold tracking-widest uppercase text-golden-1 mb-4 block">Our Vision</span>
                            <h2 className="text-golden-2 md:text-golden-3 font-bold mb-8 leading-tight">
                                <span className="text-[#A855F7]">Non-profit</span> community built by <span className="text-[#00C6F7]">students</span>, for <span className="text-[#00C6F7]">students</span>.
                            </h2>
                            <p className="text-golden-1 text-gray-400 leading-relaxed mb-8">
                            ...
                            <div className="grid grid-cols-2 gap-8 border-t border-[#00C6F7]/20 pt-8">
                                <div>
                                    <h3 className="text-golden-3 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00C6F7] to-[#A855F7] mb-2">2000+</h3>
                                    <p className="text-golden-1 text-gray-500 uppercase tracking-widest">Active Members</p>
                                </div>
                                <div>
                                    <h3 className="text-golden-3 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#A855F7] to-[#00C6F7] mb-2">15+</h3>
                                    <p className="text-golden-1 text-gray-500 uppercase tracking-widest">Events Hosted</p>
                                </div>
                            </div>
                        </div>

                        <div className="relative h-72 sm:h-80 md:h-96 w-full rounded-lg overflow-hidden shadow-lg border border-[#00C6F7]/20 mt-8 md:mt-0">
                            <img
            ...
            <section id="events" className="py-24 md:py-32 bg-[#0A0A0F] text-white">
                <div className="container mx-auto px-6">


                    {/* Past Events Gallery */}
                    <div className="flex items-center justify-between mb-12">
                        <h3 className="text-golden-2 font-bold text-white">Community Moments</h3>
                        <div className="flex gap-2">
                            <button className="p-2 rounded-full border border-[#00C6F7]/30 hover:bg-[#00C6F7] hover:text-black transition-colors"><ArrowRight className="rotate-180" /></button>
                            <button className="p-2 rounded-full border border-[#00C6F7]/30 hover:bg-[#00C6F7] hover:text-black transition-colors"><ArrowRight /></button>
                        </div>
                    </div>
            ...
            {/* Hall of Fame */}
            <section className="py-32 bg-[#0D0D2B] text-white overflow-hidden relative">
                <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'radial-gradient(circle, #00C6F7 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-golden-2 md:text-golden-3 font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#FFD700] to-[#FFA500]">Hall of Fame</h2>
                        <p className="text-golden-1 text-gray-400 max-w-3xl mx-auto">Celebrating the outstanding achievements of our community members.</p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-10">
                        {hallOfFameEntries.map((entry, i) => (
                            <motion.div
                                ...
                                className="bg-[#0A0A0F] border border-[#FFD700]/30 hover:border-[#FFD700]/70 text-white p-1 rounded-sm shadow-[0_8px_32px_0_rgba(255,215,0,0.1)] hover:shadow-[0_8px_40px_0_rgba(255,215,0,0.2)] w-full max-w-xs transform hover:-translate-y-2 transition-all duration-300"
                            >
                                ...
                                <div className="px-6 pb-8 text-center">
                                    ...
                                    <div className="w-12 h-1 bg-gradient-to-r from-[#FFD700] to-[#FFA500] mx-auto mb-4"></div>
            ...
            {/* Team / Mafia Gang */}
            <section id="community" className="py-8 md:py-16 bg-[#0F0F1A] text-white">
                <div className="container mx-auto px-6 text-center">
                    <span className="text-[#00C6F7] font-bold tracking-widest uppercase text-xs md:text-sm text-golden-1 mb-2 block">Community</span>
                    <h2 className="text-2xl md:text-4xl text-golden-2 md:text-golden-3 font-bold mb-3 text-white">The Mafia Gang</h2>
                    <p className="text-golden-1 text-gray-400 text-sm md:text-base max-w-2xl mx-auto mb-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-y-6 gap-x-2 md:gap-x-4">
                        ...
                        <div className="col-span-2 md:col-span-1 flex flex-col items-center group">
                            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden mb-3 border-4 border-[#00C6F7] shadow-[0_0_20px_rgba(0,198,247,0.4)] group-hover:scale-105 transition-transform">
                            ...
                            <h3 className="font-bold text-golden-2 mb-0.5 text-sm md:text-base text-white">Thiyaga B</h3>
                            <p className="text-[#00C6F7] text-golden-1 font-bold uppercase tracking-widest text-[10px] md:text-xs mb-1">Founder</p>
                            <a href="https://www.linkedin.com/in/thiyagab/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#00C6F7] transition-colors"><Linkedin size={14} /></a>
                        </div>
                        {volunteers.map((vol, i) => (
                            ...
                            >
                                <div className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden mb-2 grayscale group-hover:grayscale-0 transition-all duration-500 border-2 border-transparent group-hover:border-[#00C6F7] shadow-md group-hover:shadow-[0_0_15px_rgba(0,198,247,0.4)]">
                                    <img src={vol.photo} alt={vol.name} className="w-full h-full object-cover" />
                                </div>
                                <h3 className="font-bold text-golden-1 mb-0.5 text-xs md:text-sm text-gray-300">{vol.name}</h3>
                                {vol.link && (
                                    <a href={vol.link} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#00C6F7] transition-colors mt-1">
                                        <Linkedin size={12} />
                                    </a>
                                )}
                            </motion.div>
            ...
            {/* Tagline Section */}
            <section className="py-20 bg-[#0A0A0F] flex items-center justify-center">
                <div className="container mx-auto px-6 text-center">
                    <h2 className="text-golden-2 md:text-golden-3 font-black tracking-tighter uppercase leading-none">
                        Building Community <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00C6F7] to-[#A855F7]">Since 2023</span>
                    </h2>
                </div>
            </section>

            {/* Footer */}
            <footer className="bg-[#050508] text-gray-400 py-16 border-t border-[#00C6F7]/10">
                <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 gap-16">
                            <div>
                                ...
                                <ul className="space-y-4 text-golden-1">
                                    <li><a href="#vision" className="hover:text-[#00C6F7] transition-colors">About Us</a></li>
                                    <li><a href="#events" className="hover:text-[#00C6F7] transition-colors">Events</a></li>
                                    <li><a href="#community" className="hover:text-[#00C6F7] transition-colors">Team</a></li>
                                    <li><a href="#" className="hover:text-[#00C6F7] transition-colors">Join Discord</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="mt-16 pt-8 border-t border-[#00C6F7]/10 flex flex-col md:flex-row justify-between items-center text-golden-1 text-gray-600">
